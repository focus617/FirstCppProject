...
) : PanelWindow(p_title, p_opened, p_windowSettings)
{
	...
	// m_playButton	= &CreateWidget<UI::Widgets::Button::ButtonImage>(EDITOR_CONTEXT(editorResources)->GetTexture("Button_Play")->id, Maths::FVector2{ 20, 20 });
	// m_pauseButton	= &CreateWidget<UI::Widgets::Button::ButtonImage>(EDITOR_CONTEXT(editorResources)->GetTexture("Button_Pause")->id, Maths::FVector2{ 20, 20 });
	// m_stopButton	= &CreateWidget<UI::Widgets::Button::ButtonImage>(EDITOR_CONTEXT(editorResources)->GetTexture("Button_Stop")->id, Maths::FVector2{ 20, 20 });
