...
bool Color::operator==(const Color& p_other) {
  return this->r == p_other.r && this->g == p_other.g && this->b == p_other.b &&
         this->a == p_other.a;
}

bool Color::operator!=(const Color& p_other) { return !operator==(p_other); }

std::ostream& operator<<(std::ostream& stream, const Color& color) {
  stream << "UI::Types::Color[" << color.r << ", " << color.g << ", " << color.b
         << ", " << color.a << " ]";
  return stream;
}
