...
{
	/**
	* @brief @brief Some flags that can be passed to FileDialog instances
	*/
	...
	/**
	* @brief FileDialog is the base class for any dialog window that asks the user to select/save a file from/to the disk
	*/
	class FileDialog
	{
	public:
		...
		*/
		...
		/**
		* @brief Returns true if the file action succeeded
		*/
		bool HasSucceeded() const;

		/**
		* @brief Returns the selected file name (Make sur that HasSucceeded() returned true before calling this method)
		*/
		std::string GetSelectedFileName();

		/**
		* @brief Returns the selected file path (Make sur that HasSucceeded() returned true before calling this method)
		*/
		std::string GetSelectedFilePath();

		/**
		* @brief Returns some information about the last error (Make sur that
		* HasSucceeded() returned false before calling this method)
		*/
		std::string GetErrorInfo();

		/**
		* @brief Returns true if the selected file exists
		*/
	...
	protected:
		...
		const std::string m_dialog_title;
		std::string m_initial_directory;
		std::string m_filter;
		std::string m_error;
