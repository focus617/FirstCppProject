...
void Logger::set_log_location(const std::string &t_app_name, const std::string &t_location)
{
...
void Logger::print(int t_line_number,
...
void Logger::FATAL(const std::string &t_message,
                      int t_line_number,
                      const char *t_source_file_name)
{
...
void Logger::ERROR(const std::string &t_message,
                   int t_line_number,
                   const char *t_source_file_name)
{
