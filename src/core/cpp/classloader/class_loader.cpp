...
namespace class_loader
{
    ...
    ClassLoader::ClassLoader(
        const std::string &library_path, bool ondemand_load_unload)
    ...
    {
        LOG(INFO)
            << "class_loader::ClassLoader: Constructing new ClassLoader("
    ...
    ClassLoader::~ClassLoader()
    {
        LOG(INFO) << "class_loader::ClassLoader: Destroying class loader, unloading associated library...";
    ...
    int ClassLoader::unloadLibraryInternal(bool lock_plugin_ref_count)
    {
        ...
        // {
        //     plugin_ref_lock = std::scoped_lock<std::recursive_mutex>(plugin_ref_count_mutex_);
        // }
