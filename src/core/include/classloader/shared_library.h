...
namespace dynamicclassloader
{
    ...
    public:
        ...
        /// Throws a LibraryAlreadyLoadedException if a library has already
        /// been loaded.
        ...
        ///
        /// \brief Loads a shared library from the given path, using the
        /// given flags.  See the Flags enumeration for valid values.
        ///
        /// Throws a LibraryAlreadyLoadedException if a library has already
        /// been loaded.
        /// Throws a LibraryLoadException if the library cannot be loaded.
        ...
        ///
        /// \brief
        /// \return true if the loaded library contains a symbol with
        /// the given name.
        ///
        ...
        ///
        /// \brief
        /// \return the path of the library, as specified in a call to load()
        /// or the constructor.
        ///
        ...
        /// the debug version of a library (e.g., "d.so", "d.dll")
        ...
        /// \param args Arguments to pass to the actual class construction
        /// (arbitrary length)
    ...
    // Symbol //
    template <typename SymbolType>
    SymbolType *SharedLibrary::getSymbol(const std::string &name)
    {
    ...
    template <typename ClassType,
              ...
              typename Destructor = void(ClassType *),
              typename... ArgTypes>
    std::shared_ptr<ClassType> SharedLibrary::LoadClass(
        const std::string &constructor_name,
        const std::string &destructor_name,
        ArgTypes... args)
    {
