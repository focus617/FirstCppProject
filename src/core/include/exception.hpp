...
class XUZY_API Exception : public std::exception {
 public:
  ...
  /**
   * @brief Retrieve static string describing the exception.
   * @return a static string describing the exception.
   */
  virtual const char* name() const noexcept;

  /**
   * @brief Retrieve name of the exception class.
  ...
  /**
   * @brief Retrieve nested exception
   * @return a pointer to the nested exception, or null if no nested exception
   * exists.
   */
  const Exception* nested() const;

  /**
   * @brief Retrieve the message text of Exception
   * @return the message text.
   */
  const std::string& message() const;

  /**
   * @brief Retrieve the exception code if defined.
   * @return the exception code if defined.
   */
  int code() const;

  /**
   * @brief Retrieve a string consisting of the message name and the message
   * text.
   * @return a string consisting of the message name and the message text.
   */
 ...
 protected:
   ...
   * @param the exception code if defined.
   */
...
/**
 * @brief Macros for quickly declaring and implementing exception classes.
 *
 * Unfortunately, we cannot use a template here because character pointers
 * (which we need for specifying the exception name) are not allowed as template
 * arguments.
 */
#define XUZY_DECLARE_EXCEPTION_CODE(API, CLS, BASE, CODE)                     \
  class API XUZY_API CLS : public BASE {                                      \
   public:                                                                    \
    ...
    CLS(const std::string& msg, const xuzy::Exception& exc, int code = CODE); \
    CLS(const CLS& exc);                                                      \
    ~CLS() noexcept;                                                          \
...
#define XUZY_IMPLEMENT_EXCEPTION(CLS, BASE, NAME)                              \
  ...
  CLS::CLS(const std::string& msg, const std::string& arg, int code)           \
      : BASE(msg, arg, code) {}                                                \
  CLS::CLS(const std::string& msg, const xuzy::Exception& exc, int code)       \
      : BASE(msg, exc, code) {}                                                \
  ...
  xuzy::Exception* CLS::clone() const { return new CLS(*this); }               \
...
XUZY_DECLARE_EXCEPTION(XUZY_API, AssertionViolationException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, NullPointerException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, NullValueException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, BugcheckException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, InvalidArgumentException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, NotImplementedException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, RangeException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, IllegalStateException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, InvalidAccessException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, SignalException, LogicException)
XUZY_DECLARE_EXCEPTION(XUZY_API, UnhandledException, LogicException)

XUZY_DECLARE_EXCEPTION(XUZY_API, RuntimeException, Exception)
XUZY_DECLARE_EXCEPTION(XUZY_API, NotFoundException, RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, ExistsException, RuntimeException)
...
XUZY_DECLARE_EXCEPTION(XUZY_API, LibraryAlreadyLoadedException,
                       RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, NoThreadAvailableException, RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, PropertyNotSupportedException,
                       RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, PoolOverflowException, RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, NoPermissionException, RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, OutOfMemoryException, RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, UnknownURISchemeException, RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, TooManyURIRedirectsException, RuntimeException)
XUZY_DECLARE_EXCEPTION(XUZY_API, BadCastException, RuntimeException)
